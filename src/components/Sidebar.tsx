...
export default function Sidebar() {
  return (
    <aside className="bg-stone-300 text-stone-800 p-6 space-y-6 rounded-md">
      <div>
      ...
      <div className="text-sm text-stone-800 space-y-4 mt-3">
        <div>
      ...
      <div className="text-sm text-stone-800 space-y-4 mt-3">
        <div>
          <p className="font-bold text-center">Persisch – Muttersprache</p>
        </div>
        <div>
          <p className="font-bold text-center">Deutsch – verhandlungssicher</p>
        </div>
        <div>
          <p className="font-bold text-center">Englisch – gut in Wort und Schrift</p>
        </div>
      </div>
    </aside>
  );
